...
class LoggerInterceptor : CariocaInstrumentedInterceptor {
    ...
    override fun onStageStarted(report: InstrumentedStage) {
        log("Stage started: $report")
    }

    override fun onStagePassed(report: InstrumentedStage) {
        log("Stage passed: $report")
    }

    override fun onStageFailed(report: InstrumentedStage) {
