...
import com.rubensousa.carioca.android.report.stage.InstrumentedBefore
...
class InstrumentedBlockingBefore internal constructor(
    delegateFactory: InstrumentedReportDelegateFactory<InstrumentedStageScope>,
    title: String,
    outputPath: String,
) : InstrumentedBefore(title, outputPath), InstrumentedStageScope {
