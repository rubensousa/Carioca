...
import com.rubensousa.carioca.hilt.fragment.HiltFragmentScenario
import com.rubensousa.carioca.hilt.fragment.launchHiltFragment
import com.rubensousa.carioca.hilt.fragment.withFragment
...
class HiltFragmentScenarioTest {
    ...
    fun testActivityThemeIsSet() {
        ...
        assertThat(activity.theme.toString()).contains("com.rubensousa.carioca.hilt.fragment.test:style/WhiteBackgroundTheme")
    }
